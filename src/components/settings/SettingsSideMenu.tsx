import { accountSettingsMenu, workspaceSettingsMenu } from '@/constants/constants'
        ...
        <div className="inline-flex gap-3 items-center">
          ...
          <div className="mt-3">
            ...
            {accountSettingsMenu.map((data, _) => (
              <li className="list-none">
                <Button variant={"ghost"} onClick={() => toogleTab(data.id)} className="pl-0">
          ...
          <div className="mt-3">
            ...
            {workspaceSettingsMenu.map((data, _) => (
              <li className="list-none">
                <Button variant={"ghost"} className="pl-0" onClick={() => toogleTab(data.id)}>
                  {<data.icon className="mr-1" />}
                  {data.name}
                </Button>
              </li>
